...
const SignUp = () => {
  ...
  const handleSubmit = async () => {
    ...
    // Send verification email and flip to verification screen
            ...
            <View className="auth-content">
              ...
              <View className="auth-card">
                <View className="auth-form">
                  ...
                  <Pressable
                    className={`auth-secondary-button ${resendDisabled ? "opacity-50" : ""}`}
                  ...
                  {resendMessage ? (
                    <Text className="text-center text-sm font-sans-medium text-success">
                      {resendMessage}
                    </Text>
                  ) : null}
